...
func TestCIRequiresMigrationGatePostgresIntegration(t *testing.T) {
	...
	if strings.Contains(workflow, "TestRequireCurrentSchemaRejects124AndAccepts132") {
		t.Fatal("required PostgreSQL CI selector still names the pre-migration-133 schema test")
	}
}
