...
func TestCIRequiresMigrationGatePostgresIntegration(t *testing.T) {
	...
	if strings.Contains(workflow, "TestRequireCurrentSchemaRejects124AndAccepts133") {
		t.Fatal("required PostgreSQL CI selector still names the pre-migration-134 schema test")
	}
}
