...
UNIPOST_API_KEY=up_live_xxx ./gradlew run -PunipostJavaSdkVersion=0.7.0 -PuseLocalSdk=true
UNIPOST_API_KEY=up_live_xxx TEST_ACCOUNT_ID=<id> ./gradlew run -PunipostJavaSdkVersion=0.7.0 -PuseLocalSdk=true
```
