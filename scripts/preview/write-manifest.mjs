...
export function createPreviewManifest({ sha, branch, apiURL }) {
  ...
  if (!/^(?:(?:dev-|hotfix-)[a-z0-9][a-z0-9-]*|codex\/(?:(?:staging-|pr270-)[a-z0-9][a-z0-9-]*|social-account-profile-bindings))$/i.test(branch ?? "")) {
    throw new Error(
      "Preview manifest branch must use the dev-<task-slug>, hotfix-<task-slug>, codex/staging-<task-slug>, codex/pr270-<task-slug>, or codex/social-account-profile-bindings form",
    );
  }
