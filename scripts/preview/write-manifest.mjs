...
export function createPreviewManifest({ sha, branch, apiURL }) {
  ...
  if (!/^(?:(?:dev-|hotfix-)[a-z0-9][a-z0-9-]*|codex\/staging-[a-z0-9][a-z0-9-]*)$/i.test(branch ?? "")) {
    throw new Error(
      "Preview manifest branch must use the dev-<task-slug>, hotfix-<task-slug>, or codex/staging-<task-slug> form",
    );
  }
