          ...
          <ul className="doc-sidebar-list">
            {NAV_ITEMS.map(([id, label]) => (
              <li key={id} className="doc-sidebar-item">
                <a href={`#${id}`} className="doc-sidebar-link" onClick={() => setActiveSection(id)}>
                  {label}
                </a>
              </li>
            ))}
