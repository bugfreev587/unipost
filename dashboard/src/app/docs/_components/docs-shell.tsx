    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Managed Users", href: "/docs/api#managed-users" },
          { label: "Account Health", href: "/docs/api#account-health" },
        ],
      },
      {
        title: "Publishing",
        items: [
          ...
          { label: "Drafts", href: "/docs/api#drafts" },
          { label: "Preview Links", href: "/docs/api#preview-links" },
