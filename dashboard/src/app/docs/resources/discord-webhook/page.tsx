...
export default function DiscordWebhookPage() {
  return (
    ...
    >
      ...
      <p>
        After the channel is marked <strong>Verified</strong>, go to the <Link href="/docs/resources/notifications#subscribe-events">subscribe events section</Link> and turn on the alerts you want.
      </p>
