...
export default function NotificationsPage() {
  return (
    ...
    >
      ...
      <p>
        If you want the exact Slack UI flow, use this page: <Link href="/docs/resources/slack-webhook">How to get a Slack webhook URL</Link>.
      </p>
      <p>
        Short version:
      </p>
      ...
      <p>
        If Discord&apos;s official guide feels too vague, use our shorter guide here: <Link href="/docs/resources/discord-webhook">How to get a Discord webhook URL</Link>.
      </p>
      <p>
        Short version:
      </p>
