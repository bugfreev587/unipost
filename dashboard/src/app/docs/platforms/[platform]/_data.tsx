...
const icons = {
  ...
  youtube: <YouTubeBrandIcon size={26} />,
  pinterest: (
    <svg viewBox="0 0 24 24" width="26" height="26" fill="currentColor" aria-hidden>
...
export const PLATFORMS: Record<string, PlatformDoc> = {
    ...
    mediaSpecs: [
      {
        ...
        text: [
          ["Character limit", "280 in UniPost today — URLs count as 23 chars, emoji count as 2"],
          ["Premium long posts", "Not exposed by UniPost today; use threads for longer X content"],
        ...
        video: [
          ...
          ["Duration", "0.5 sec – 140 sec through UniPost today"],
          ["Premium long video", "Not exposed by UniPost today"],
    ...
    mediaSpecs: [
      {
        ...
        image: [
          ...
          ["Max per post", "4"],
          ["Max file size", "2 MB per image (UniPost upload validation cap)"],
        ...
        video: [
          ...
          ["Max per post", "1"],
          ["Max file size", "100 MB (UniPost upload validation cap)"],
          ["Max duration", "60 sec"],
    ...
    mediaSpecs: [
      {
        ...
        image: [
          ["Formats", "JPEG, PNG"],
          ["Max per post", "9 images through UniPost"],
          ["Max file size", "100 MB per image (UniPost validation cap)"],
        ...
        video: [
          ...
          ["Max per post", "1"],
          ["Max file size", "5 GB"],
          ["Duration", "3 sec – 10 min through UniPost"],
    ...
    mediaSpecs: [
      {
        ...
        video: [
          ...
          ["Max file size", "1 GB (UniPost validation cap)"],
          ["Duration", "3 sec – 90 sec through UniPost"],
      ...
      },
      {
        ...
        video: [
          ...
          ["Per-item max size", "1 GB (UniPost validation cap)"],
          ["Per-item duration", "3 sec – 90 sec through UniPost"],
  ...
  tiktok: {
    ...
    capabilities: [
      ...
      ["Analytics", partial, "Post engagement + view count require TikTok analytics scopes. Those analytics scopes are approved for production and requested for newly connected accounts; reconnect older accounts before relying on live analytics."],
    ...
    analytics: [
      ["Video views", partial, "Requires `video.list`; this scope is approved for production and requested for newly connected accounts"],
      ["Likes", partial, "Requires `video.list`; this scope is approved for production and requested for newly connected accounts"],
      ["Comments", partial, "Requires `video.list`; this scope is approved for production and requested for newly connected accounts"],
      ["Shares", partial, "Requires `video.list`; this scope is approved for production and requested for newly connected accounts"],
  ...
  "platform_options": {
    ...
    limitations: [
      ...
      ["Analytics scopes are approved", "Production OAuth requests `user.info.profile`, `user.info.stats`, and `video.list` for newly connected accounts. Reconnect older accounts if they were authorized before these scopes were available."],
  ...
  pinterest: {
    ...
    capabilities: [
      ...
      ["Analytics", partial, "Impressions, engagements, saves, and outbound clicks when production analytics access is available"],
  ...
  facebook: {
    ...
    analytics: [
      ["Likes", yes, "Sum of reactions on the post"],
      ["Comments", yes, "Top-level comment count"],
      ["Shares", yes, "Native Facebook share count"],
      ["Clicks", yes, "Sum of `post_clicks_by_type` (Graph v22.0)"],
      ["Video views", yes, "`post_video_views_organic + paid` — only on video posts"],
      ["Impressions", no, "Meta dropped post-level impressions in Graph v22.0 — use Page Insights tab for Page-level"],
      ["Reach", no, "Meta dropped post-level reach in Graph v22.0 — use Page Insights tab for Page-level"],
      ["Saves", no, "Not exposed by Meta for Facebook Pages"],
    ],
    inbox: {
