...
System.out.println(accounts);`,
  ...
  twitter: {
    ...
    lead: "Configure the workspace X app identity, both UniPost OAuth callbacks, and the app-level credentials required for publishing and public-reply delivery. X DMs remain a controlled rollout.",
    ...
    beforeYouStart: [
      ...
      "The app Bearer Token for X comments. Keep the Consumer Secret only for a future approved private Activity webhook path.",
    ],
    steps: [
      {
      ...
      },
      {
        ...
        body: "Use the X / Twitter credential row in UniPost's Platform Credentials screen. Client ID and Client Secret enable OAuth and publishing. The app Bearer Token enables the X comments stream. Store a Consumer Secret only for a future approved private Activity webhook path; the current release does not provision DM subscriptions. UniPost never returns secret values after write.",
      },
      {
    ...
    fieldMap: [
      ...
      ["Bearer Token", "App Bearer Token", "Required for workspace_x_app Filtered Stream management."],
      ["Consumer Secret", "Consumer Secret", "Reserved for a future approved X Activity webhook verification path; not used to provision DM subscriptions today."],
    ...
    gotchas: [
      ...
      ["Partial Inbox credentials", "Publishing can stay available with Client ID and Client Secret. X comments additionally require the app Bearer Token. Saving a Consumer Secret does not enable private DM subscriptions in the current rollout."],
    ],
    doneChecklist: [
      ...
      "Account capabilities report no missing_app_credentials for the workspace_x_app feature being tested.",
      "The account has tweet.read, tweet.write, users.read, and offline.access. dm.read and dm.write are additionally verified only when the workspace is included in the controlled DM rollout.",
