...
export default function PlatformCredentialGuidePage() {
  ...
  return (
    <DocsPage
      eyebrow="Platform credential setup"
      title={guide.title}
      lead={guide.lead}
    ...
    >
      ...
      <div className="wlp-next">
        <Link href="/docs/platform-credentials" className="wlp-next-card">
          <div className="wlp-next-kicker">Overview</div>
          <div className="wlp-next-title">Platform Credentials overview</div>
          <div className="wlp-next-body">
            Return to the main credential guide for quota ownership, callback URLs, and setup order.
          </div>
        </Link>
        <Link href="/docs/api/platform-credentials" className="wlp-next-card">
