...
const BODY_FIELDS: ApiFieldItem[] = [
  ...
  { name: "return_url?", type: "string", description: "Where UniPost redirects the user after completion. This is not the OAuth callback URL or platform redirect_uri." },
    ...
    >
      <section className="api-field-section">
        ...
        <p>
          ...
          UniPost completes the session. Platform OAuth callback URLs are
