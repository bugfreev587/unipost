...
export const metadata: Metadata = {
  ...
  description: "List all connected social media accounts in your project. Filter by platform and external_user_id. Returns account status, connection type, and platform metadata.",
