...
const RESPONSE_FIELDS: ApiFieldItem[] = [
  ...
  { name: "social_account_id", type: "string", description: "Connected social account ID column." },
  { name: "profile_id", type: "string", description: "UniPost profile ID column." },
  { name: "result_status", type: "string", description: "Platform delivery result status column." },
  { name: "post_status", type: "string", description: "UniPost post status column." },
  { name: "external_id", type: "string", description: "Native platform post ID column." },
  { name: "url", type: "string", description: "Native platform post URL column, when available." },
  { name: "created_at", type: "string", description: "UniPost post creation timestamp column." },
  { name: "published_at", type: "string", description: "Platform publish timestamp column, when available." },
  { name: "impressions", type: "number", description: "Normalized impressions column." },
  { name: "reach", type: "number", description: "Normalized reach column." },
  { name: "likes", type: "number", description: "Normalized likes column." },
  { name: "comments", type: "number", description: "Normalized comments column." },
  { name: "shares", type: "number", description: "Normalized shares column." },
  ...
  { name: "video_views", type: "number", description: "Normalized video views column." },
  { name: "engagement_rate", type: "number", description: "Computed engagement rate column." },
  { name: "fetched_at", type: "string", description: "Timestamp when analytics were last fetched." },
