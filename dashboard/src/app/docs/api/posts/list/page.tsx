...
const QUERY_FIELDS: ApiFieldItem[] = [
  { name: "status?", type: "string", description: <>Comma-separated status filter. Example: <code style={{ color: "var(--docs-accent)", fontFamily: "var(--docs-mono)", fontSize: 13 }}>published,partial</code>.<EnumValues values={["draft", "scheduled", "publishing", "published", "partial", "failed", "cancelled"]} /></> },
...
const RESPONSE_200_FIELDS: ApiFieldItem[] = [
  ...
  { name: "data[].status", type: "string", description: <>Derived lifecycle status for the post.<EnumValues values={["draft", "scheduled", "publishing", "published", "partial", "failed", "cancelled"]} /></> },
  ...
  { name: "data[].target_platforms", type: "string[]", description: <>Platforms inferred from stored metadata.<EnumValues values={["twitter", "linkedin", "instagram", "facebook", "threads", "youtube", "tiktok", "bluesky", "pinterest"]} /></> },
