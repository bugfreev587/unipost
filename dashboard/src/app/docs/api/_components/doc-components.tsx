...
const ENDPOINT_DOC_LINKS: Array<{ match: RegExp; href: string }> = [
  ...
  { match: /^GET \/v1\/billing\/x-credits\/events$/i, href: "/docs/api/x-credits#events" },
  ...
  { match: /^GET \/v1\/(?:accounts|social-accounts)\/[^/]+\/profile$/i, href: "/docs/api/accounts/profile" },
  { match: /^GET \/v1\/(?:accounts|social-accounts)\/[^/]+\/posts$/i, href: "/docs/api/accounts/posts" },
