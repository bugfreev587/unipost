...
// ── Styles ──
const CSS = `:root{--bg:var(--app-bg);--s1:var(--marketing-surface);--s2:var(--marketing-surface-alt);--s3:var(--marketing-surface-elevated);--border:var(--marketing-border);--b2:var(--marketing-border-strong);--b3:var(--marketing-border-strong);--pr-text:var(--marketing-text);--muted:var(--marketing-muted);--muted2:var(--marketing-subtle);--accent:var(--primary);--adim:var(--success-soft);--blue:var(--marketing-link);--shadow-soft:var(--marketing-shadow-soft);--shadow-lg:var(--marketing-shadow-lg);--r:8px;--mono:var(--font-fira-code),monospace;--ui:var(--font-dm-sans),system-ui,sans-serif;--content-max:1400px;--px:32px}*{box-sizing:border-box;margin:0;padding:0}body{background:var(--bg);color:var(--pr-text);font-family:var(--ui);font-size:15px;line-height:1.6;-webkit-font-smoothing:antialiased}.pr-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 18px;border-radius:var(--r);font-size:13.5px;font-weight:600;cursor:pointer;transition:all .15s;border:1px solid transparent;font-family:var(--ui);text-decoration:none;white-space:nowrap}.pr-btn-primary{background:var(--blue);color:#fff}.pr-btn-primary:hover{background:var(--marketing-link-hover)}.pr-btn-ghost{background:transparent;color:var(--muted);border-color:var(--b2)}.pr-btn-ghost:hover{background:var(--s2);color:var(--pr-text);border-color:var(--b3)}.pr-btn-tier{width:100%;justify-content:center;padding:10px;font-size:13.5px;border-radius:9px;background:var(--s2);color:var(--pr-text);border-color:var(--b2)}.pr-btn-tier:hover{background:var(--s3);border-color:var(--b3)}.pr-btn-tier-hi{background:var(--blue);color:#fff;border-color:var(--blue);font-weight:700}.pr-btn-tier-hi:hover{background:var(--marketing-link-hover);border-color:var(--marketing-link-hover)}.pr-btn-ent{background:transparent;color:var(--pr-text);border-color:var(--b2);padding:10px 24px;font-size:14px;flex-shrink:0}.pr-btn-ent:hover{background:var(--s2);border-color:var(--b3)}.pr-page{max-width:var(--content-max);margin:0 auto;padding:0 var(--px) 96px}.pr-hero{padding:96px 0 56px;text-align:center}.pr-hero-title{font-size:64px;font-weight:900;letter-spacing:-2px;line-height:1.04;color:var(--pr-text);margin-bottom:20px}.pr-hero-sub{font-size:17px;color:var(--muted);max-width:640px;margin:0 auto 12px;line-height:1.7}.pr-hero-altlink{font-size:13px;color:var(--muted2);margin-top:18px}.pr-hero-altlink a{color:var(--blue);text-decoration:underline}.pr-cards{display:grid;grid-template-columns:repeat(5,1fr);gap:14px;margin-bottom:18px}.pr-card{background:var(--s1);border:1px solid var(--border);border-radius:14px;padding:24px 20px;display:flex;flex-direction:column;box-shadow:var(--shadow-soft);position:relative}.pr-card.hi{border-color:var(--accent);box-shadow:0 0 0 1px var(--accent),var(--shadow-soft)}.pr-card.current{border-color:var(--accent);box-shadow:0 0 0 1px var(--accent),var(--shadow-soft)}.pr-ribbon{position:absolute;top:-11px;left:50%;transform:translateX(-50%);background:var(--accent);color:#fff;font-size:10.5px;font-weight:700;padding:3px 10px;border-radius:20px;font-family:var(--mono);letter-spacing:.04em;white-space:nowrap}.pr-current-badge{position:absolute;top:-11px;left:50%;transform:translateX(-50%);background:var(--accent);color:#fff;font-size:10.5px;font-weight:700;padding:3px 10px;border-radius:20px;font-family:var(--mono);letter-spacing:.04em;white-space:nowrap}.pr-tname{font-size:14px;font-weight:700;color:var(--pr-text);letter-spacing:.02em;margin-bottom:8px;text-transform:uppercase;font-family:var(--mono)}.pr-tprice{font-size:32px;font-weight:900;letter-spacing:-1px;color:var(--pr-text);line-height:1;font-family:var(--mono)}.pr-tprice .mo{font-size:14px;font-weight:400;color:var(--muted);letter-spacing:0;margin-left:2px}.pr-tprice.custom{font-size:22px;letter-spacing:-.5px}.pr-tposts{font-size:12.5px;color:var(--muted);font-family:var(--mono);margin-top:6px}.pr-tblurb{font-size:13px;color:var(--muted);line-height:1.55;margin:14px 0 16px;min-height:40px}.pr-tdivider{height:1px;background:var(--border);margin-bottom:14px}.pr-tfeats{flex:1;margin-bottom:18px}.pr-tfeat{display:flex;align-items:flex-start;gap:8px;font-size:12.5px;color:var(--pr-text);margin-bottom:9px;line-height:1.4}.pr-tfeat svg{width:13px;height:13px;flex-shrink:0;margin-top:2px}.pr-tfeat .chk{color:var(--accent)}.pr-tfeat .chk-no{color:var(--muted2)}.pr-tfeat.dim{color:var(--muted)}.pr-tfeat.headline{font-weight:700;color:var(--pr-text);padding-bottom:8px;border-bottom:1px dashed var(--border);margin-bottom:11px}.pr-tfeat.headline svg{display:none}.pr-soft{background:var(--s1);border:1px solid var(--border);border-radius:14px;padding:22px 26px;margin-bottom:64px;display:flex;gap:18px;align-items:flex-start;box-shadow:var(--shadow-soft)}.pr-soft-icon{width:40px;height:40px;flex-shrink:0;background:var(--adim);border:1px solid color-mix(in srgb,var(--accent) 18%,transparent);border-radius:10px;display:flex;align-items:center;justify-content:center}.pr-soft-icon svg{width:18px;height:18px;color:var(--accent)}.pr-soft-title{font-size:15px;font-weight:700;margin-bottom:6px;color:var(--pr-text)}.pr-soft-desc{font-size:13.5px;color:var(--muted);line-height:1.65}.pr-soft-mono{font-family:var(--mono);font-size:12px;color:var(--pr-text);background:var(--s2);border:1px solid var(--border);padding:2px 6px;border-radius:4px}.pr-compare{margin-bottom:64px}.pr-compare-title{font-size:36px;font-weight:800;letter-spacing:-.5px;margin-bottom:28px;text-align:center;color:var(--pr-text)}.pr-compare-wrap{border:1px solid var(--border);border-radius:14px;overflow:hidden;box-shadow:var(--shadow-soft)}.pr-compare-hdr{display:grid;grid-template-columns:2fr repeat(5,1fr);background:var(--s2);border-bottom:1px solid var(--border)}.pr-ch{padding:16px 20px;font-size:13px;font-weight:700;color:var(--muted);letter-spacing:.06em;text-transform:uppercase;font-family:var(--mono)}.pr-ch.hl{color:var(--accent)}.pr-compare-row{display:grid;grid-template-columns:2fr repeat(5,1fr);border-bottom:1px solid var(--border);transition:background .1s}.pr-compare-row:last-child{border-bottom:none}.pr-compare-row:hover{background:var(--s2)}.pr-cr{padding:18px 20px;display:flex;align-items:center}.pr-cr-feat{flex-direction:column;align-items:flex-start}.pr-cr-name{font-size:15.5px;font-weight:600;color:var(--pr-text);line-height:1.35}.pr-cr-sub{font-size:13px;color:var(--muted);margin-top:5px;line-height:1.5}.pr-chk{color:var(--accent)}.pr-cr svg.pr-chk{width:22px;height:22px;flex-shrink:0;stroke-width:2.6}.pr-dash{color:var(--muted2);font-size:24px;line-height:1;font-weight:400}.pr-cr-val{font-family:var(--mono);font-size:14px;color:var(--pr-text);font-weight:500}.pr-cr-val.hl{color:var(--accent);font-weight:700}.pr-ent{background:var(--s1);border:1px solid var(--border);border-radius:14px;padding:32px 36px;display:flex;align-items:center;justify-content:space-between;gap:32px;margin-bottom:64px;box-shadow:var(--shadow-soft)}.pr-ent-title{font-size:20px;font-weight:700;letter-spacing:-.3px;margin-bottom:8px;color:var(--pr-text)}.pr-ent-desc{font-size:13.5px;color:var(--muted);line-height:1.65;max-width:520px}.pr-ent-chips{display:flex;flex-wrap:wrap;gap:8px;margin-top:14px}.pr-ent-chip{display:flex;align-items:center;gap:6px;font-size:12px;color:var(--muted);background:var(--s2);border:1px solid var(--border);padding:4px 10px;border-radius:20px}.pr-ent-chip svg{width:11px;height:11px;color:var(--accent)}.pr-faq-title{font-size:32px;font-weight:800;letter-spacing:-.5px;margin-bottom:24px;text-align:center;color:var(--pr-text)}.pr-faq-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:64px}.pr-faq-item{background:var(--s1);border:1px solid var(--border);border-radius:12px;padding:22px 24px;transition:border-color .15s;box-shadow:var(--shadow-soft)}.pr-faq-item:hover{border-color:var(--b2)}.pr-faq-q{font-size:14.5px;font-weight:600;margin-bottom:9px;color:var(--pr-text)}.pr-faq-a{font-size:13px;color:var(--muted);line-height:1.7}.pr-trial{font-size:11.5px;color:var(--accent);font-weight:600;text-align:center;margin-bottom:8px;font-family:var(--mono)}@media(min-width:1700px){:root{--content-max:1500px;--px:40px}}@media(max-width:1300px){.pr-cards{grid-template-columns:repeat(3,1fr)}.pr-compare-hdr,.pr-compare-row{grid-template-columns:1.6fr repeat(5,1fr)}}@media(max-width:1024px){:root{--content-max:100%;--px:24px}.pr-cards{grid-template-columns:repeat(2,1fr)}.pr-faq-grid{grid-template-columns:1fr}.pr-ent{flex-direction:column;align-items:flex-start}.pr-compare-wrap{overflow-x:auto}.pr-compare-hdr,.pr-compare-row{grid-template-columns:1.4fr repeat(5,minmax(110px,1fr));min-width:780px}}@media(max-width:680px){.pr-page{padding-bottom:72px}.pr-hero{padding:64px 0 40px}.pr-hero-title{font-size:42px}.pr-cards{grid-template-columns:1fr}.pr-soft,.pr-ent{padding:22px}.pr-compare-title,.pr-faq-title{font-size:26px}}`;
