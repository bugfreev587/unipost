...
export default function PricingPage() {
  ...
  const showPaidTrialPromo = !isSignedIn || trialEligible === true;
      ...
      <div className="pr-page">
        ...
        <div className="pr-cards">
          {TIERS.map((t) => {
            ...
            const showTrial = t.id !== "free" && t.price !== null && showPaidTrialPromo && !isCurrent;
            ...
            return (
              <div key={t.id} className={`pr-card ${t.highlight ? "hi" : ""} ${isCurrent ? "current" : ""}`}>
                ...
                {showTrial && <div className="pr-trial-badge">14-day free trial</div>}
