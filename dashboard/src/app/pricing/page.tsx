...
const THEME_OVERRIDES = `html{--bg:var(--app-bg);--s1:var(--surface);--s2:var(--surface2);--s3:var(--surface3);--border:var(--border-soft);--b2:var(--border-strong);--b3:color-mix(in srgb,var(--border-strong) 72%, var(--text) 28%);--text:var(--text);--muted:var(--text-muted);--muted2:var(--text-subtle);--accent:var(--primary);--adim:var(--accent-dim);--blue:var(--info)}.pr-nav{background:color-mix(in srgb,var(--app-bg) 78%, transparent)}.pr-btn-primary,.pr-btn-paid{color:var(--primary-foreground)}.pr-btn-primary:hover,.pr-btn-paid:hover{background:var(--info)}.pr-current-badge{color:var(--primary-foreground)}.pr-dropdown{box-shadow:0 16px 40px var(--shadow-color)}.pr-soft-icon{border-color:color-mix(in srgb,var(--primary) 14%, transparent)}`;
    ...
    <>
      ...
      <div className="pr-page">
        ...
        <div className="pr-hero">
          ...
          <p style={{ fontSize: 13, color: "var(--text-muted)", marginTop: -28 }}>Comparing with competitors? <Link href="/alternatives/ayrshare" style={{ color: "var(--text-muted)", textDecoration: "underline" }}>UniPost vs Ayrshare</Link> · <Link href="/alternatives/zernio" style={{ color: "var(--text-muted)", textDecoration: "underline" }}>UniPost vs Zernio</Link></p>
        </div>
