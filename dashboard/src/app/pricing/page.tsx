...
const FAQS = [
  ...
  { q: "Is there a free trial?", a: "The Free plan is the trial: 100 posts/month, no credit card, and no time limit. Paid plans do not include a separate time-limited trial by default." },
