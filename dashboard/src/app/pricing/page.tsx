...
const FEATURES_FREE = [
  ...
  { text: "All 6 platforms", included: true }, { text: "Webhooks", included: true },
...
const COMPARE_ROWS = [
  ...
  { name: "All 6 platforms", sub: "Bluesky, LinkedIn, Instagram, Threads, TikTok, YouTube", free: true, paid: true },
    ...
    <>
      ...
      <div className="pr-page">
            ...
            <div className="pr-feats">
              {FEATURES_FREE.map((f) => (
                <div key={f.text} className={`pr-feat ${!f.included ? "dim" : ""}`}>
                  {f.included ? <CheckIcon className="chk" /> : <svg className="chk-no" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 8h8" /></svg>}
                  {f.text}
                </div>
              ))}
            </div>
        ...
        <div className="pr-soft">
          <div className="pr-soft-icon"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="8" cy="8" r="6.5" /><path d="M8 5v3M8 10v1" /></svg></div>
          <div>
