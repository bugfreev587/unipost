...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Paid Quota", href: "/admin/paid-quota", section: "Overview", enabled: true, icon: Gauge },
  { label: "Object Storage", href: "/admin/object-storage", section: "Overview", enabled: true, icon: HardDrive },
  { label: "Feature Flags", href: "/admin/feature-flags", section: "Overview", enabled: true, icon: Flag },
  { label: "Publishing Restrictions", href: "/admin/publishing-restrictions", section: "Overview", enabled: true, icon: ShieldAlert },
