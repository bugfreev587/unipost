...
response = requests.post(
  ...
  faq: [
    ...
    { q: "Does Pinterest work in Sandbox?", a: "Yes for publishing and board workflows while your Pinterest app has trial access. Standard access makes API-created Pins and boards visible normally instead of creator-only sandbox entities." },
    { q: "What analytics can I get from Pinterest?", a: "With approved Pinterest API access, UniPost can fetch Pin-level metrics like impressions, saves, and outbound clicks through the same analytics flow used by other platforms. Some organic analytics depend on the connected user's Pinterest account type." },
