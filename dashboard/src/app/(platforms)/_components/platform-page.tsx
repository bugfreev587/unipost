...
.pp-section-label{font-size:11px;color:var(--accent);text-transform:uppercase;letter-spacing:.12em;font-weight:700;margin-bottom:10px;font-family:var(--mono)}
.pp-section-title{font-size:36px;font-weight:800;letter-spacing:-.6px;margin-bottom:10px;line-height:1.1}
.pp-section-sub{font-size:14px;color:var(--muted);max-width:480px;line-height:1.7;margin-bottom:40px}
      ...
      <div className="pp-page">
        ...
        <div className="pp-hero">
          <div className="pp-plat-badge">
            <div className="pp-plat-icon" style={{ background: cfg.brandColor + "15" }}>{cfg.icon}</div>
          ...
          <div className="pp-hero-actions">
            ...
            <Link href={`/docs/connect/${cfg.slug}`} className="lp-btn lp-btn-ghost lp-btn-lg">
              View {cfg.name} Docs →
            </Link>
          </div>
