...
const PLATFORM_ICONS: Record<string, React.ReactNode> = {
  ...
  youtube: <PublicPlatformIcon platform="youtube" size={18} />,
...
.pp-app-pw-card{background:var(--s1);border:1px solid var(--border);border-radius:10px;padding:28px;max-width:600px;margin-left:auto;margin-right:auto}
...
.pp-footer-top{display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr 1fr;gap:36px;margin-bottom:48px}
