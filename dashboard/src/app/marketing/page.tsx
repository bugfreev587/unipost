          ...
          <div className="lp-nav-links">
            ...
            <div className="lp-nav-dropdown">
              ...
              <div className="lp-nav-dropdown-menu">
                <Link href="/docs" className="lp-nav-dropdown-item">
                  ...
                  <span><div className="lp-nav-dropdown-label">API Reference</div><div className="lp-nav-dropdown-desc">REST API docs, endpoints, and examples</div></span>
                </Link>
                <Link href="/docs#mcp" className="lp-nav-dropdown-item">
                  ...
                  <span><div className="lp-nav-dropdown-label">MCP Server</div><div className="lp-nav-dropdown-desc">Connect AI agents to social platforms</div></span>
                </Link>
              </div>
            </div>
          </div>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          <div className="lp-footer-top">
            ...
            <div><div className="lp-footer-col-title">Product</div><ul className="lp-footer-links"><li><Link href="/" className="lp-footer-link">Overview</Link></li><li><Link href="/pricing" className="lp-footer-link">Pricing</Link></li><li><Link href="/docs" className="lp-footer-link">API Reference</Link></li><li><Link href="/docs#mcp" className="lp-footer-link">MCP Server</Link></li></ul></div>
