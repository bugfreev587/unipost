      ...
      <div className="lp-page">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 16 }}>
            {CAPABILITIES.map((item) => (
              <div key={item.title} style={{ background: "var(--s1)", border: "1px solid var(--border)", borderRadius: 14, padding: 24 }}>
                ...
                <p style={{ fontSize: 14.5, color: "var(--body-soft)", lineHeight: 1.75, marginBottom: 14 }}>{item.desc}</p>
        ...
        <div style={{ padding: "0 0 var(--section-py)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 18, alignItems: "stretch" }}>
            <div style={{ background: "var(--proof-panel-bg)", border: "1px solid var(--border)", borderRadius: 16, padding: 24 }}>
              <div style={{ fontSize: 12, color: "var(--accent)", fontFamily: "var(--mono)", marginBottom: 14 }}>Branded Connect Flow</div>
              <div style={{ background: "var(--connect-card-bg)", color: "var(--connect-card-text)", borderRadius: 14, padding: 24, maxWidth: 420, boxShadow: "var(--connect-card-shadow)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
                  <div style={{ width: 42, height: 42, borderRadius: 10, background: "var(--connect-card-brand-bg)", color: "var(--connect-card-brand-text)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800 }}>A</div>
                  <div>
                    <div style={{ fontWeight: 700 }}>Acme Social</div>
                    <div style={{ fontSize: 12, color: "var(--connect-card-meta)" }}>Powered by UniPost</div>
                  </div>
                </div>
                <h3 style={{ fontSize: 22, fontWeight: 800, marginBottom: 8 }}>Connect your LinkedIn account</h3>
                <p style={{ fontSize: 14, lineHeight: 1.6, color: "var(--connect-card-copy)", marginBottom: 18 }}>
                  Your users see your brand during onboarding while UniPost handles the OAuth mechanics and token lifecycle underneath.
                </p>
                <div style={{ background: "var(--connect-card-button-bg)", color: "var(--connect-card-button-text)", borderRadius: 10, textAlign: "center", padding: "12px 16px", fontWeight: 700 }}>
            ...
            <div style={{ display: "grid", gap: 12 }}>
              {PROOF_STEPS.map((item) => (
                <div key={item.step} style={{ background: "var(--s1)", border: "1px solid var(--border)", borderRadius: 14, padding: 20 }}>
                  ...
                  <p style={{ fontSize: 14, color: "var(--body-soft)", lineHeight: 1.7 }}>{item.body}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="lp-cta-band">
        <div className="lp-cta-band-inner">
          <div className="lp-cta-inner">
            ...
            <p style={{ fontSize: 13, color: "var(--cta-note)", marginTop: 20, position: "relative" }}>Need to prove the AI-native path too? <Link href="/tools/agentpost" style={{ color: "var(--cta-link)", textDecoration: "underline" }}>Try AgentPost</Link> or <Link href="/compare" style={{ color: "var(--cta-link)", textDecoration: "underline" }}>see competitor comparisons →</Link></p>
          </div>
        </div>
      </div>
