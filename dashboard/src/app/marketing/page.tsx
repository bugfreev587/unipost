...
const THEME_OVERRIDES = `html{--bg:var(--app-bg);--s1:var(--surface);--s2:var(--surface2);--s3:var(--surface3);--border:var(--border-soft);--b2:var(--border-strong);--b3:color-mix(in srgb,var(--border-strong) 72%, var(--text) 28%);--text:var(--text);--muted:var(--text-muted);--muted2:var(--text-subtle);--accent:var(--primary);--adim:var(--accent-dim);--blue:var(--info);--blue-dim:var(--info-soft)}.lp-nav{background:color-mix(in srgb,var(--app-bg) 78%, transparent)}.lp-nav-dropdown-menu{box-shadow:0 18px 44px var(--shadow-color)}.lp-btn-primary{color:var(--primary-foreground)}.lp-btn-primary:hover{background:var(--info);box-shadow:0 0 24px color-mix(in srgb,var(--info) 24%, transparent)}.lp-btn-hero-primary{background:var(--primary);color:var(--primary-foreground);box-shadow:0 14px 30px color-mix(in srgb,var(--primary) 22%, transparent)}.lp-btn-hero-primary:hover{background:var(--primary-hover);box-shadow:0 18px 34px color-mix(in srgb,var(--primary) 28%, transparent)}.lp-btn-hero-outline{border-color:color-mix(in srgb,var(--border-strong) 72%, transparent)}.lp-btn-hero-outline:hover{background:color-mix(in srgb,var(--surface3) 72%, transparent);border-color:var(--border-strong)}.lp-hero-badge{border-color:color-mix(in srgb,var(--primary) 18%, transparent)}.lp-hero-sub,.lp-section-sub,.lp-integ-card-desc,.lp-feat-desc,.lp-stat-label,.lp-mode-desc,.lp-faq-a,.lp-cta-sub,.lp-footer-tagline,.lp-footer-link,.lp-plat-chip{color:var(--text-muted)}.lp-plat-label{color:var(--text-subtle)}.lp-editor-line:hover{background:color-mix(in srgb,var(--text) 4%, transparent)}.lp-editor-ln{color:var(--text-subtle)}.lp-feat-code{color:var(--text-muted)}.lp-mode-card:hover{border-color:var(--border-strong);box-shadow:0 8px 32px var(--shadow-color)}.lp-mode-card.mode-quickstart:hover{box-shadow:0 8px 32px color-mix(in srgb,var(--primary) 10%, transparent)}.lp-mode-card.mode-native:hover{box-shadow:0 8px 32px color-mix(in srgb,var(--info) 10%, transparent)}.lp-faq-band{background:color-mix(in srgb,var(--app-bg) 92%, var(--surface) 8%);border-top:1px solid var(--border-soft)}.lp-cta-band{background:color-mix(in srgb,var(--app-bg) 95%, var(--surface) 5%)}.lp-cta-inner{background:var(--surface);border-color:var(--border-soft)}.lp-cta-glow{background:radial-gradient(circle,color-mix(in srgb,var(--primary) 10%, transparent),transparent 70%)}`;
      ...
      <div className="lp-page">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 16 }}>
            {CAPABILITIES.map((item) => (
              <div key={item.title} style={{ background: "var(--s1)", border: "1px solid var(--border)", borderRadius: 14, padding: 24 }}>
                ...
                <p style={{ fontSize: 14.5, color: "var(--text-muted)", lineHeight: 1.75, marginBottom: 14 }}>{item.desc}</p>
        ...
        <div style={{ padding: "0 0 var(--section-py)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 18, alignItems: "stretch" }}>
            <div style={{ background: "linear-gradient(180deg, var(--surface2), var(--surface))", border: "1px solid var(--border)", borderRadius: 16, padding: 24 }}>
              <div style={{ fontSize: 12, color: "var(--accent)", fontFamily: "var(--mono)", marginBottom: 14 }}>Branded Connect Flow</div>
              <div style={{ background: "var(--surface-raised)", color: "var(--text)", borderRadius: 14, padding: 24, maxWidth: 420, boxShadow: "0 16px 50px var(--shadow-color)", border: "1px solid var(--border-soft)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
                  <div style={{ width: 42, height: 42, borderRadius: 10, background: "var(--text)", color: "var(--surface)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800 }}>A</div>
                  <div>
                    <div style={{ fontWeight: 700 }}>Acme Social</div>
                    <div style={{ fontSize: 12, color: "var(--text-muted)" }}>Powered by UniPost</div>
                  </div>
                </div>
                <h3 style={{ fontSize: 22, fontWeight: 800, marginBottom: 8 }}>Connect your LinkedIn account</h3>
                <p style={{ fontSize: 14, lineHeight: 1.6, color: "var(--text-muted)", marginBottom: 18 }}>
                  Your users see your brand during onboarding while UniPost handles the OAuth mechanics and token lifecycle underneath.
                </p>
                <div style={{ background: "var(--text)", color: "var(--surface)", borderRadius: 10, textAlign: "center", padding: "12px 16px", fontWeight: 700 }}>
      ...
      <div className="lp-cta-band">
        <div className="lp-cta-band-inner">
          <div className="lp-cta-inner">
            ...
            <p style={{ fontSize: 13, color: "var(--text-muted)", marginTop: 20, position: "relative" }}>Need to prove the AI-native path too? <Link href="/tools/agentpost" style={{ color: "var(--text-muted)", textDecoration: "underline" }}>Try AgentPost</Link> or <Link href="/compare" style={{ color: "var(--text-muted)", textDecoration: "underline" }}>see competitor comparisons →</Link></p>
          </div>
        </div>
      </div>
