      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          <div className="lp-footer-top">
            ...
            <div><div className="lp-footer-col-title">Developers</div><ul className="lp-footer-links"><li><Link href="/docs" className="lp-footer-link">API Reference</Link></li><li><Link href="/docs#mcp" className="lp-footer-link">MCP Server</Link></li></ul></div>
