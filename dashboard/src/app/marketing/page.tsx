    ...
    <>
      ...
      <nav className="lp-nav">
        <div className="lp-nav-inner">
          <Link href="/marketing" className="lp-logo">
      ...
      <div className="lp-page">
        ...
        <div className="lp-hero">
          ...
          <div className={`lp-hero-rotate-wrap ${visible ? "" : "hidden"}`} aria-live="polite">{rotatingText}.</div>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          <div className="lp-footer-top">
            ...
            <div><div className="lp-footer-col-title">Product</div><ul className="lp-footer-links"><li><Link href="/marketing" className="lp-footer-link">Overview</Link></li><li><Link href="/pricing" className="lp-footer-link">Pricing</Link></li><li><Link href="/docs" className="lp-footer-link">Docs</Link></li></ul></div>
