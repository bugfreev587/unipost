    ...
    <>
      ...
      <div className="lp-page">
        ...
        <div className="lp-hero">
          ...
          <div className="lp-hero-rotate-wrap" aria-live="polite"><span className={`lp-hero-rotate-text ${rotatePhase}`}>{rotatingText}.</span></div>
