...
const CSS = `:root{--bg:var(--app-bg);--s1:var(--marketing-surface);--s2:var(--marketing-surface-alt);--s3:var(--marketing-surface-elevated);--border:var(--marketing-border);--b2:var(--marketing-border-strong);--b3:var(--marketing-border-strong);--cmp-text:var(--marketing-text);--muted:var(--marketing-muted);--muted2:var(--marketing-subtle);--accent:var(--primary);--adim:var(--success-soft);--blue:var(--marketing-link);--r:8px;--mono:var(--font-fira-code),monospace;--ui:var(--font-dm-sans),system-ui,sans-serif;--nav-max:1480px;--content-max:1200px;--px:32px;--section-py:96px}*{box-sizing:border-box;margin:0;padding:0}body{background:var(--bg);color:var(--cmp-text);font-family:var(--ui);font-size:15px;line-height:1.6;-webkit-font-smoothing:antialiased}

/* NAV */
.cmp-nav{position:sticky;top:0;z-index:50;border-bottom:1px solid var(--marketing-nav-border);background:var(--marketing-nav-bg);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}.cmp-nav-inner{max-width:var(--nav-max);margin:0 auto;padding:0 var(--px);height:56px;display:flex;align-items:center;justify-content:space-between}.cmp-logo{display:flex;align-items:center;gap:10px;text-decoration:none}.cmp-logo-mark{width:28px;height:28px;background:var(--accent);border-radius:7px;display:flex;align-items:center;justify-content:center}.cmp-logo-mark svg{width:14px;height:14px;color:var(--primary-foreground)}.cmp-logo-name{font-size:16px;font-weight:700;letter-spacing:-.4px;color:var(--cmp-text)}.cmp-nav-links{display:flex;gap:4px}.cmp-nav-link{padding:6px 14px;font-size:14px;font-weight:500;color:var(--muted);border-radius:var(--r);transition:color .1s;text-decoration:none}.cmp-nav-link:hover{color:var(--cmp-text)}

/* BUTTONS */
.cmp-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 18px;border-radius:var(--r);font-size:13.5px;font-weight:600;cursor:pointer;transition:all .15s;border:1px solid transparent;font-family:var(--ui);text-decoration:none;white-space:nowrap}.cmp-btn-primary{background:var(--blue);color:#fff}.cmp-btn-primary:hover{background:var(--marketing-link-hover);box-shadow:0 0 24px color-mix(in srgb,var(--marketing-link) 20%,transparent)}.cmp-btn-ghost{background:transparent;color:var(--muted);border-color:var(--b2)}.cmp-btn-ghost:hover{background:var(--s2);color:var(--cmp-text);border-color:var(--b3)}.cmp-btn-lg{padding:12px 28px;font-size:15px;border-radius:10px}

/* PAGE */
.cmp-page{max-width:var(--content-max);margin:0 auto;padding:0 var(--px)}

/* HERO */
.cmp-hero{padding:96px 0 var(--section-py);text-align:center;display:flex;flex-direction:column;align-items:center}.cmp-hero-title{font-size:56px;font-weight:900;letter-spacing:-2px;line-height:1.08;margin-bottom:20px}.cmp-hero-sub{font-size:17px;color:var(--muted);max-width:600px;line-height:1.75;margin-bottom:40px}

/* COMPETITOR CARDS */
.cmp-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:var(--section-py)}.cmp-card{background:var(--s1);border:1px solid var(--b2);border-radius:14px;padding:32px;transition:all .2s;text-decoration:none;color:var(--cmp-text)}.cmp-card:hover{border-color:var(--accent);transform:translateY(-2px);box-shadow:0 8px 32px var(--accent-glow)}.cmp-card-name{font-size:20px;font-weight:800;letter-spacing:-.3px;margin-bottom:8px}.cmp-card-desc{font-size:13.5px;color:var(--muted);line-height:1.6;margin-bottom:20px}.cmp-card-highlights{list-style:none;margin-bottom:24px}.cmp-card-hl{display:flex;align-items:flex-start;gap:8px;font-size:13px;color:var(--cmp-text);margin-bottom:8px;line-height:1.4}.cmp-card-hl svg{color:var(--accent);flex-shrink:0;margin-top:2px}.cmp-card-link{font-size:13px;font-weight:600;color:var(--accent);font-family:var(--mono)}

/* TABLE */
.cmp-table-section{margin-bottom:var(--section-py)}.cmp-table-title{font-size:36px;font-weight:800;letter-spacing:-.8px;margin-bottom:32px;text-align:center}.cmp-table-wrap{border:1px solid var(--border);border-radius:14px;overflow:hidden;overflow-x:auto}.cmp-table-hdr{display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr;background:var(--s2);border-bottom:1px solid var(--border);min-width:700px}.cmp-th{padding:14px 20px;font-size:12.5px;font-weight:600;color:var(--muted);letter-spacing:.03em}.cmp-th.hl{color:var(--accent)}.cmp-th a{color:inherit;text-decoration:none}.cmp-th a:hover{color:var(--cmp-text)}.cmp-row{display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr;border-bottom:1px solid var(--border);transition:background .1s;min-width:700px}.cmp-row:last-child{border-bottom:none}.cmp-row:hover{background:var(--s2)}.cmp-cell{padding:12px 20px;display:flex;align-items:center;font-size:14px}.cmp-cell-label{font-weight:500;color:var(--cmp-text)}.cmp-chk{color:var(--accent)}.cmp-chk svg{width:15px;height:15px}.cmp-x{color:var(--muted2);font-size:16px}.cmp-coming{font-size:12px;color:var(--muted);font-family:var(--mono);background:var(--s2);padding:2px 8px;border-radius:4px;border:1px solid var(--border)}.cmp-val{font-size:13.5px;color:var(--cmp-text)}

/* CTA */
.cmp-cta{background:var(--app-bg);border-top:1px solid var(--border);padding:var(--section-py) 0}.cmp-cta-inner{max-width:var(--content-max);margin:0 auto;padding:0 var(--px)}.cmp-cta-card{background:var(--s1);border:1px solid var(--border);border-radius:16px;padding:72px 48px;text-align:center;position:relative;overflow:hidden;box-shadow:var(--marketing-shadow-soft)}.cmp-cta-glow{position:absolute;width:400px;height:400px;border-radius:50%;background:var(--marketing-glow);top:50%;left:50%;transform:translate(-50%,-50%);pointer-events:none}.cmp-cta-title{font-size:44px;font-weight:900;letter-spacing:-1.2px;margin-bottom:16px;position:relative}.cmp-cta-sub{font-size:15px;color:var(--muted);margin-bottom:36px;position:relative}.cmp-cta-actions{display:flex;justify-content:center;gap:12px;position:relative}

/* FOOTER */
.cmp-footer{width:100%;border-top:1px solid var(--border);padding:48px 0}.cmp-footer-inner{max-width:var(--content-max);margin:0 auto;padding:0 var(--px)}.cmp-footer-top{display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr;gap:48px;margin-bottom:48px}.cmp-footer-logo{display:flex;align-items:center;gap:9px;margin-bottom:16px}.cmp-footer-mark{width:26px;height:26px;background:var(--accent);border-radius:6px;display:flex;align-items:center;justify-content:center}.cmp-footer-mark svg{width:13px;height:13px;color:var(--primary-foreground)}.cmp-footer-name{font-size:15px;font-weight:700;color:var(--cmp-text)}.cmp-footer-tagline{font-size:13px;color:var(--muted);line-height:1.65;max-width:260px}.cmp-footer-col-title{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--muted2);margin-bottom:16px}.cmp-footer-links{list-style:none}.cmp-footer-link{font-size:13.5px;color:var(--muted);margin-bottom:10px;cursor:pointer;transition:color .1s;display:block;text-decoration:none}.cmp-footer-link:hover{color:var(--cmp-text)}.cmp-footer-bottom{border-top:1px solid var(--border);padding-top:24px;display:flex;align-items:center;justify-content:space-between}.cmp-footer-copy{font-size:13px;color:var(--muted2)}.cmp-footer-social{display:flex;gap:12px}.cmp-footer-social-link{width:32px;height:32px;background:var(--s2);border:1px solid var(--border);border-radius:6px;display:flex;align-items:center;justify-content:center;color:var(--muted);cursor:pointer;transition:all .15s;font-size:14px;text-decoration:none}.cmp-footer-social-link:hover{background:var(--s3);color:var(--cmp-text);border-color:var(--b2)}

/* LP-BTN COMPAT (MarketingNav/CTA use lp- classes) */
.lp-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 18px;border-radius:var(--r);font-size:13.5px;font-weight:600;cursor:pointer;transition:all .15s;border:1px solid transparent;font-family:var(--ui);text-decoration:none;white-space:nowrap}.lp-btn-primary{background:var(--blue);color:#fff}.lp-btn-primary:hover{background:var(--marketing-link-hover);box-shadow:0 0 24px color-mix(in srgb,var(--marketing-link) 20%,transparent)}.lp-btn-ghost{background:transparent;color:var(--muted);border-color:var(--b2)}.lp-btn-ghost:hover{background:var(--s2);color:var(--cmp-text);border-color:var(--b3)}.lp-btn-outline{background:transparent;color:var(--cmp-text);border-color:var(--b2)}.lp-btn-outline:hover{background:var(--s2);border-color:var(--b3)}.lp-btn-lg{padding:12px 28px;font-size:15px;border-radius:10px}
