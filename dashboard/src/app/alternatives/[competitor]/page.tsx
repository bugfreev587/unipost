...
// ── Styles ──
const CSS = `:root{--bg:var(--app-bg);--s1:var(--marketing-surface);--s2:var(--marketing-surface-alt);--s3:var(--marketing-surface-elevated);--border:var(--marketing-border);--b2:var(--marketing-border-strong);--b3:var(--marketing-border-strong);--alt-text:var(--marketing-text);--muted:var(--marketing-muted);--muted2:var(--marketing-subtle);--accent:var(--primary);--adim:var(--success-soft);--blue:var(--marketing-link);--r:8px;--mono:var(--font-fira-code),monospace;--ui:var(--font-dm-sans),system-ui,sans-serif;--nav-max:1480px;--content-max:1100px;--px:32px;--section-py:96px}*{box-sizing:border-box;margin:0;padding:0}body{background:var(--bg);color:var(--alt-text);font-family:var(--ui);font-size:15px;line-height:1.6;-webkit-font-smoothing:antialiased}

/* NAV */
.alt-nav{position:sticky;top:0;z-index:50;border-bottom:1px solid var(--marketing-nav-border);background:var(--marketing-nav-bg);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}.alt-nav-inner{max-width:var(--nav-max);margin:0 auto;padding:0 var(--px);height:56px;display:flex;align-items:center;justify-content:space-between}.alt-logo{display:flex;align-items:center;gap:10px;text-decoration:none}.alt-logo-mark{width:28px;height:28px;background:var(--accent);border-radius:7px;display:flex;align-items:center;justify-content:center}.alt-logo-mark svg{width:14px;height:14px;color:var(--primary-foreground)}.alt-logo-name{font-size:16px;font-weight:700;letter-spacing:-.4px;color:var(--alt-text)}.alt-nav-links{display:flex;gap:4px}.alt-nav-link{padding:6px 14px;font-size:14px;font-weight:500;color:var(--muted);border-radius:var(--r);transition:color .1s;text-decoration:none}.alt-nav-link:hover{color:var(--alt-text)}

/* BUTTONS */
.alt-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 18px;border-radius:var(--r);font-size:13.5px;font-weight:600;cursor:pointer;transition:all .15s;border:1px solid transparent;font-family:var(--ui);text-decoration:none;white-space:nowrap}.alt-btn-primary{background:var(--blue);color:#fff}.alt-btn-primary:hover{background:var(--marketing-link-hover);box-shadow:0 0 24px color-mix(in srgb,var(--marketing-link) 20%,transparent)}.alt-btn-ghost{background:transparent;color:var(--muted);border-color:var(--b2)}.alt-btn-ghost:hover{background:var(--s2);color:var(--alt-text);border-color:var(--b3)}.alt-btn-lg{padding:12px 28px;font-size:15px;border-radius:10px}

/* PAGE */
.alt-page{max-width:var(--content-max);margin:0 auto;padding:0 var(--px)}

/* BREADCRUMB */
.alt-bread{padding:24px 0 0;font-size:13px;color:var(--muted2)}.alt-bread a{color:var(--muted);text-decoration:none}.alt-bread a:hover{color:var(--alt-text)}.alt-bread-sep{margin:0 8px}

/* HERO */
.alt-hero{padding:64px 0 var(--section-py);text-align:center;display:flex;flex-direction:column;align-items:center}.alt-hero-title{font-size:56px;font-weight:900;letter-spacing:-2px;line-height:1.08;color:var(--alt-text);margin-bottom:24px;max-width:800px;white-space:pre-line}.alt-hero-sub{font-size:17px;color:var(--muted);max-width:600px;line-height:1.75;margin-bottom:40px}.alt-hero-actions{display:flex;gap:12px;margin-bottom:28px}.alt-hero-meta{display:flex;gap:20px;font-size:13px;color:var(--muted2)}.alt-hero-meta-item{display:flex;align-items:center;gap:6px}.alt-hero-meta-item svg{color:var(--accent)}

/* VERDICT */
.alt-verdict{margin-bottom:var(--section-py)}.alt-verdict-card{background:var(--s1);border:1px solid var(--b2);border-radius:16px;padding:40px 48px}.alt-verdict-title{font-size:22px;font-weight:800;letter-spacing:-.3px;margin-bottom:28px;color:var(--alt-text)}.alt-verdict-grid{display:grid;grid-template-columns:1fr 1fr;gap:48px}.alt-verdict-col-title{font-size:14px;font-weight:700;color:var(--accent);margin-bottom:16px}.alt-verdict-col-title.them{color:var(--muted)}.alt-verdict-item{display:flex;align-items:flex-start;gap:10px;font-size:14px;color:var(--alt-text);margin-bottom:12px;line-height:1.5}.alt-verdict-item svg{color:var(--accent);flex-shrink:0;margin-top:2px}

/* COMPARISON TABLE */
.alt-table-section{margin-bottom:var(--section-py)}.alt-table-title{font-size:36px;font-weight:800;letter-spacing:-.8px;margin-bottom:32px;text-align:center}.alt-table-wrap{border:1px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:24px}.alt-table-hdr{display:grid;grid-template-columns:2.5fr 1fr 1fr;background:var(--s2);border-bottom:1px solid var(--border)}.alt-th{padding:14px 24px;font-size:12.5px;font-weight:600;color:var(--muted);letter-spacing:.03em}.alt-th.hl{color:var(--accent)}.alt-section-hdr{display:grid;grid-template-columns:1fr;background:var(--s1);border-bottom:1px solid var(--border);padding:12px 24px}.alt-section-label{font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:var(--muted2)}.alt-row{display:grid;grid-template-columns:2.5fr 1fr 1fr;border-bottom:1px solid var(--border);transition:background .1s}.alt-row:last-child{border-bottom:none}.alt-row:hover{background:var(--s2)}.alt-cell{padding:14px 24px;display:flex;align-items:center;font-size:14px}.alt-cell-label{color:var(--alt-text);font-weight:500}.alt-chk{color:var(--accent)}.alt-chk svg{width:15px;height:15px}.alt-x{color:var(--muted2);font-size:16px}.alt-coming{font-size:12px;color:var(--muted);font-family:var(--mono);background:var(--s2);padding:2px 8px;border-radius:4px;border:1px solid var(--border)}.alt-val{font-size:13.5px;color:var(--alt-text)}

/* PRICING COMPARISON */
.alt-pricing{margin-bottom:var(--section-py)}.alt-pricing-title{font-size:36px;font-weight:800;letter-spacing:-.8px;margin-bottom:32px;text-align:center}.alt-pricing-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:24px}.alt-pricing-card{background:var(--s1);border:1px solid var(--border);border-radius:14px;padding:32px;position:relative}.alt-pricing-card.ours{border-color:var(--accent)}.alt-pricing-card-badge{position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:var(--accent);color:var(--primary-foreground);font-size:11px;font-weight:700;padding:3px 14px;border-radius:20px;font-family:var(--mono);white-space:nowrap}.alt-pricing-card-name{font-size:18px;font-weight:700;margin-bottom:20px}.alt-pricing-tier{display:flex;justify-content:space-between;align-items:center;padding:10px 0;border-bottom:1px solid var(--border);font-size:14px}.alt-pricing-tier:last-child{border-bottom:none}.alt-pricing-tier-name{color:var(--alt-text)}.alt-pricing-tier-price{font-family:var(--mono);font-weight:600;color:var(--alt-text)}.alt-pricing-note{font-size:14px;color:var(--muted);text-align:center;max-width:600px;margin:0 auto;line-height:1.7}

/* MCP SECTION */
.alt-mcp{margin-bottom:var(--section-py)}.alt-mcp-grid{display:grid;grid-template-columns:1.2fr 1fr;gap:48px;align-items:start}.alt-mcp-code{background:var(--s2);border:1px solid var(--border);border-radius:10px;padding:24px 28px;font-family:var(--mono);font-size:13px;line-height:1.7;color:var(--alt-text);white-space:pre;overflow-x:auto}.alt-mcp-code-label{font-size:12px;color:var(--muted);font-family:var(--mono);margin-bottom:8px}.alt-mcp-points{list-style:none}.alt-mcp-point{display:flex;align-items:flex-start;gap:10px;font-size:14.5px;color:var(--alt-text);margin-bottom:14px;line-height:1.5}.alt-mcp-point svg{color:var(--accent);flex-shrink:0;margin-top:3px}.alt-mcp-note{font-size:14px;color:var(--muted);margin-top:20px;padding-top:20px;border-top:1px solid var(--border)}

/* MIGRATION */
.alt-migrate{margin-bottom:var(--section-py)}.alt-migrate-steps{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:32px}.alt-migrate-step{background:var(--s1);border:1px solid var(--border);border-radius:12px;padding:28px 32px}.alt-migrate-step-num{font-family:var(--mono);font-size:12px;color:var(--accent);font-weight:600;margin-bottom:10px;letter-spacing:.05em}.alt-migrate-step-title{font-size:16px;font-weight:700;margin-bottom:8px}.alt-migrate-step-desc{font-size:13.5px;color:var(--muted);line-height:1.6}.alt-migrate-code{font-family:var(--mono);font-size:12.5px;background:var(--s2);padding:3px 8px;border-radius:4px;color:var(--alt-text);margin-top:8px;display:inline-block}.alt-migrate-bottom{text-align:center}.alt-migrate-quote{font-size:15px;color:var(--muted);font-style:italic;margin-bottom:20px}

/* FAQ */
.alt-faq{margin-bottom:var(--section-py)}.alt-faq-title{font-size:36px;font-weight:800;letter-spacing:-.8px;margin-bottom:32px;text-align:center}.alt-faq-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.alt-faq-item{background:var(--s1);border:1px solid var(--border);border-radius:10px;padding:24px 26px;transition:border-color .15s}.alt-faq-item:hover{border-color:var(--b2)}.alt-faq-q{font-size:15px;font-weight:600;margin-bottom:10px}.alt-faq-a{font-size:13.5px;color:var(--muted);line-height:1.7}

/* CTA BANNER */
.alt-cta{background:var(--app-bg);border-top:1px solid var(--border);padding:var(--section-py) 0;margin-bottom:0}.alt-cta-inner{max-width:var(--content-max);margin:0 auto;padding:0 var(--px)}.alt-cta-card{background:var(--s1);border:1px solid var(--border);border-radius:16px;padding:72px 48px;text-align:center;position:relative;overflow:hidden;box-shadow:var(--marketing-shadow-soft)}.alt-cta-glow{position:absolute;width:400px;height:400px;border-radius:50%;background:var(--marketing-glow);top:50%;left:50%;transform:translate(-50%,-50%);pointer-events:none}.alt-cta-title{font-size:44px;font-weight:900;letter-spacing:-1.2px;margin-bottom:16px;position:relative}.alt-cta-sub{font-size:15px;color:var(--muted);margin-bottom:36px;position:relative}.alt-cta-actions{display:flex;justify-content:center;gap:12px;position:relative}

/* FOOTER */
.alt-footer{width:100%;border-top:1px solid var(--border);padding:48px 0}.alt-footer-inner{max-width:var(--content-max);margin:0 auto;padding:0 var(--px)}.alt-footer-top{display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr;gap:48px;margin-bottom:48px}.alt-footer-logo{display:flex;align-items:center;gap:9px;margin-bottom:16px}.alt-footer-mark{width:26px;height:26px;background:var(--accent);border-radius:6px;display:flex;align-items:center;justify-content:center}.alt-footer-mark svg{width:13px;height:13px;color:var(--primary-foreground)}.alt-footer-name{font-size:15px;font-weight:700;color:var(--alt-text)}.alt-footer-tagline{font-size:13px;color:var(--muted);line-height:1.65;max-width:260px}.alt-footer-col-title{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--muted2);margin-bottom:16px}.alt-footer-links{list-style:none}.alt-footer-link{font-size:13.5px;color:var(--muted);margin-bottom:10px;cursor:pointer;transition:color .1s;display:block;text-decoration:none}.alt-footer-link:hover{color:var(--alt-text)}.alt-footer-bottom{border-top:1px solid var(--border);padding-top:24px;display:flex;align-items:center;justify-content:space-between}.alt-footer-copy{font-size:13px;color:var(--muted2)}.alt-footer-social{display:flex;gap:12px}.alt-footer-social-link{width:32px;height:32px;background:var(--s2);border:1px solid var(--border);border-radius:6px;display:flex;align-items:center;justify-content:center;color:var(--muted);cursor:pointer;transition:all .15s;font-size:14px;text-decoration:none}.alt-footer-social-link:hover{background:var(--s3);color:var(--alt-text);border-color:var(--b2)}
...
.lp-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 18px;border-radius:var(--r);font-size:13.5px;font-weight:600;cursor:pointer;transition:all .15s;border:1px solid transparent;font-family:var(--ui);text-decoration:none;white-space:nowrap}.lp-btn-primary{background:var(--blue);color:#fff}.lp-btn-primary:hover{background:var(--marketing-link-hover);box-shadow:0 0 24px color-mix(in srgb,var(--marketing-link) 20%,transparent)}.lp-btn-ghost{background:transparent;color:var(--muted);border-color:var(--b2)}.lp-btn-ghost:hover{background:var(--s2);color:var(--alt-text);border-color:var(--b3)}.lp-btn-outline{background:transparent;color:var(--alt-text);border-color:var(--b2)}.lp-btn-outline:hover{background:var(--s2);border-color:var(--b3)}.lp-btn-lg{padding:12px 28px;font-size:15px;border-radius:10px}
      ...
      <div className="alt-page">
        ...
        <div className="alt-pricing">
          ...
          <p className="alt-pricing-note">
            UniPost&apos;s pricing is product-tier based. Free includes the API and dashboard. Basic ($19/mo) bundles Inbox and Analytics. Growth ($59/mo) adds white-label. Team ($149/mo) adds RBAC and team collaboration.
          </p>
        </div>
