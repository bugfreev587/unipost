...
// ── Styles ──
const CSS = `:root{--bg:var(--app-bg);--s1:var(--marketing-surface);--s2:var(--marketing-surface-alt);--s3:var(--marketing-surface-elevated);--border:var(--marketing-border);--b2:var(--marketing-border-strong);--b3:var(--marketing-border-strong);--text:var(--marketing-text);--muted:var(--marketing-muted);--muted2:var(--marketing-subtle);--accent:var(--primary);--adim:var(--success-soft);--blue:var(--marketing-link);--r:8px;--mono:var(--font-fira-code),monospace;--ui:var(--font-dm-sans),system-ui,sans-serif;--nav-max:1480px;--content-max:1100px;--px:32px;--section-py:96px}*{box-sizing:border-box;margin:0;padding:0}body{background:var(--bg);color:var(--text);font-family:var(--ui);font-size:15px;line-height:1.6;-webkit-font-smoothing:antialiased}

/* NAV */
.alt-nav{position:sticky;top:0;z-index:50;border-bottom:1px solid var(--marketing-nav-border);background:var(--marketing-nav-bg);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}.alt-nav-inner{max-width:var(--nav-max);margin:0 auto;padding:0 var(--px);height:56px;display:flex;align-items:center;justify-content:space-between}.alt-logo{display:flex;align-items:center;gap:10px;text-decoration:none}.alt-logo-mark{width:28px;height:28px;background:var(--accent);border-radius:7px;display:flex;align-items:center;justify-content:center}.alt-logo-mark svg{width:14px;height:14px;color:var(--primary-foreground)}.alt-logo-name{font-size:16px;font-weight:700;letter-spacing:-.4px;color:var(--text)}.alt-nav-links{display:flex;gap:4px}.alt-nav-link{padding:6px 14px;font-size:14px;font-weight:500;color:var(--muted);border-radius:var(--r);transition:color .1s;text-decoration:none}.alt-nav-link:hover{color:var(--text)}
