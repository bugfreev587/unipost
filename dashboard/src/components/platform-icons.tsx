...
const ICONS: Record<string, PlatformIconDef> = {
  ...
  instagram: {
    ...
    node: (
      <>
        <defs>
          <radialGradient id="platform-icon-instagram-gradient" cx="30%" cy="107%" r="150%">
        ...
        <path
          fill="url(#platform-icon-instagram-gradient)"
  ...
  pinterest: {
    ...
    viewBox: "0 0 24 24",
    node: (
      <path d="M12.04 0C5.41 0 0 5.41 0 12.04c0 4.88 2.91 9.08 7.09 10.95-.1-.93-.18-2.36.04-3.38.2-.86 1.24-5.28 1.24-5.28s-.31-.62-.31-1.54c0-1.45.84-2.54 1.89-2.54.89 0 1.32.67 1.32 1.47 0 .89-.57 2.23-.86 3.47-.24 1.04.52 1.89 1.54 1.89 1.84 0 3.26-1.94 3.26-4.74 0-2.48-1.78-4.21-4.33-4.21-2.95 0-4.68 2.21-4.68 4.49 0 .89.34 1.84.77 2.36.08.1.09.19.07.29-.08.32-.25 1.04-.29 1.18-.05.19-.16.23-.37.14-1.39-.57-2.26-2.35-2.26-3.78 0-3.08 2.24-5.91 6.46-5.91 3.39 0 6.03 2.42 6.03 5.66 0 3.38-2.13 6.1-5.08 6.1-1 0-1.94-.52-2.26-1.14l-.62 2.35c-.22.86-.83 1.94-1.24 2.6.93.29 1.91.45 2.93.45 6.63 0 12.04-5.41 12.04-12.04C24.08 5.41 18.67 0 12.04 0z" />
    ),
  },
};
