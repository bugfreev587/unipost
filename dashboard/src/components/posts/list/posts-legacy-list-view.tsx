...
import {
  listSocialAccounts, listAllSocialPosts, cancelSocialPost, archiveSocialPost, restoreSocialPost, deleteSocialPost, rescheduleSocialPost,
  getActivation, listProfiles,
  type SocialAccount, type SocialPost, type Profile,
} from "@/lib/api";
import { Plus, Search, MoreHorizontal, Pencil, Send, XCircle, Calendar, ChevronDown, ChevronRight, Archive, Trash2, RotateCcw } from "lucide-react";
...
@media (max-width: 900px){.posts-expand-cell{padding:14px 16px}}
`;
