...
.posts-time-metrics-timeline{position:relative;display:flex;flex-direction:column}.posts-time-metrics-timeline::before{content:"";position:absolute;top:12px;bottom:12px;left:4px;width:1px;background:var(--dborder)}.posts-time-metrics-event{position:relative;display:grid;grid-template-columns:10px minmax(0,1fr) max-content;gap:9px;align-items:center;min-height:38px}.posts-time-metrics-dot{position:relative;z-index:1;width:7px;height:7px;border:2px solid var(--surface1);border-radius:999px;background:var(--dmuted2);box-shadow:0 0 0 1px var(--dmuted2)}.posts-time-metrics-event.is-final .posts-time-metrics-dot{background:var(--success);box-shadow:0 0 0 1px var(--success)}.posts-time-metrics-event-copy{display:flex;flex-direction:column;gap:2px;min-width:0}.posts-time-metrics-event-label{color:var(--dtext);font-size:11.5px;font-weight:650}.posts-time-metrics-event-time{overflow:hidden;color:var(--dmuted2);font-family:var(--font-geist-mono),monospace;font-size:10.5px;text-overflow:ellipsis;white-space:nowrap}.posts-time-metrics-gap{padding:3px 6px;border-radius:6px;background:var(--surface2);color:var(--dmuted);font-family:var(--font-geist-mono),monospace;font-size:10.5px;white-space:nowrap}
