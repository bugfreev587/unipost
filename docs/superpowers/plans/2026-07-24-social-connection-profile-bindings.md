...
**Files:**
- Create: `api/internal/db/migrations/121_social_connections_and_profile_bindings.sql`
...
func TestSocialConnectionsMigrationNeverMergesManagedOwners(t *testing.T) {
	body, _ := os.ReadFile("migrations/121_social_connections_and_profile_bindings.sql")
	sql := compactSocialConnectionSQL(string(body))
...
**Files:**
- Create: `api/internal/db/migrations/122_delivery_job_connection_snapshot.sql`
