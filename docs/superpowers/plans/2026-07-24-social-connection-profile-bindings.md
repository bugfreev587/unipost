...
**Files:**
- Create: `api/internal/db/migrations/128_social_connections_and_profile_bindings.sql`
...
func TestSocialConnectionsMigrationNeverMergesManagedOwners(t *testing.T) {
	body, _ := os.ReadFile("migrations/128_social_connections_and_profile_bindings.sql")
	sql := compactSocialConnectionSQL(string(body))
...
**Files:**
- Create: `api/internal/db/migrations/129_delivery_job_connection_snapshot.sql`
