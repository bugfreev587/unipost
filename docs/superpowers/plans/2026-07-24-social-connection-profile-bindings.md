...
**Files:**
- Create: `api/internal/db/migrations/137_social_connections_and_profile_bindings.sql`
...
func TestSocialConnectionsMigrationNeverMergesManagedOwners(t *testing.T) {
	body, _ := os.ReadFile("migrations/137_social_connections_and_profile_bindings.sql")
	sql := compactSocialConnectionSQL(string(body))
...
**Files:**
- Create: `api/internal/db/migrations/138_delivery_job_connection_snapshot.sql`
